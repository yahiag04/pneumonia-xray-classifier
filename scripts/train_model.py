...
from thesis.train import TrainConfig, train_model


def main():
    parser = argparse.ArgumentParser(description="Train one comparison model on the internal chest_xray dataset.")
