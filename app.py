...
def build_pdf_report(img_pil, label, prob, model_info: dict) -> bytes:
    ...
    c.drawString(margin_x, y, "Pneumonia Detection – Model Report")
    y -= 20
...
def main():
    ...
    st.write(
        ...
        "- Questo strumento è a solo scopo accademico e **non sostituisce un referto medico.**"
    )

    with st.expander("🔍 Informazioni sul Modello — PneumoniaNet"):
        st.markdown("""
        <div style="
            padding: 18px;
            border-radius: 12px;
        ...
        <h2 style='color:#58a6ff;'>🧠 Panoramica del Modello</h2>
        <p>
        <b>PneumoniaNet</b> è una rete neurale convoluzionale progettata per classificare radiografie del torace
        in due categorie: <b>Normale</b> e <b>Polmonite</b>.
        </p>

        <hr style="border: 1px solid #444;">

        <h3 style='color:#ffdd57;'>🏗️ Architettura</h3>
        <ul>
            <li>4 blocchi convoluzionali: <b>16 → 32 → 64 → 128 filtri</b></li>
            <li>Batch Normalization in ogni blocco</li>
            <li>MaxPooling dopo ogni blocco</li>
            <li>Adaptive Global Average Pooling</li>
            <li>Fully Connected finale: <b>128 → 64 → 1</b></li>
            <li>Dropout <b>0.5</b> per ridurre overfitting</li>
        </ul>
        <p><b>Input:</b> radiografia in scala di grigi 1×224×224</p>

        <hr style="border: 1px solid #444;">

        <h3 style='color:#7ee787;'>📚 Dataset</h3>
        <p>
        Dataset “Chest X-Ray Pneumonia” di Kaggle.  
        Classi disponibili: <b>Normale</b>, <b>Polmonite</b>.  
        Immagini reali, con suddivisione train/val/test già fornita.
        </p>

        <hr style="border: 1px solid #444;">

        <h3 style='color:#ffa657;'>⚙️ Parametri di Addestramento</h3>
        <ul>
        ...
        <h3 style='color:#d2a8ff;'>📈 Prestazioni</h3>
        ...
        <h3 style='color:#f85149;'>⚠️ Limitazioni</h3>
        <ul>
