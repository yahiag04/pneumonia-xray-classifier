...
EfficientNet-B0, invece, la riesecuzione con lo stesso seed ha riprodotto
bitwise lo stesso \texttt{model\_state} del benchmark principale, quindi le
metriche coincidono. Questa asimmetria e' un esito empirico degli artefatti, non
una differenza intenzionale di protocollo. I valori assoluti delle due tabelle
non devono quindi essere usati come se tutti i punti fossero la stessa identica
esecuzione; la tabella di scaling serve soprattutto a leggere l'andamento
interno delle curve nello stesso protocollo.
